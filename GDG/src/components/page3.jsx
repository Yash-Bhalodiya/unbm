...
const Page3 = () => {
    return (
        <div className='h-screen w-screen top-100'>
            ...
            <motion.div className='cardData h-1/3 w-4/5 md:w-1/4 bg-orange-400 rounded-md relative top-1/2 -left-5 flex justify-center items-center' initial={{opacity:0}} whileInView={{opacity:100}} transition={{duration:1}} ><i class="fa-solid fa-store p-7 text-7xl"></i><p className='text-3xl p-5 font-bold'>Ghost Kitchens & Stores</p></motion.div>
            <motion.div className='cardData h-1/3 w-4/5 md:w-1/4 bg-orange-400 rounded-md relative top-1/2 -left-5 flex justify-center items-center' initial={{opacity:0}} whileInView={{opacity:100}} transition={{duration:1}}><i class="fa-solid fa-truck p-7 text-7xl"></i><p className='text-3xl p-5 font-bold'>Distribution Centers</p></motion.div>
            <motion.div className='cardData h-1/3 w-4/5 md:w-1/4 bg-orange-400 rounded-md relative top-1/2 -left-5 flex justify-center items-center' initial={{opacity:0}} whileInView={{opacity:100}} transition={{duration:1}}><i class="fa-solid fa-car p-7 text-7xl"></i><p className='text-3xl p-5 font-bold'>Showrooms</p></motion.div>
            </div>
        </div>
    );
}
