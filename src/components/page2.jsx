...
const Page2 = () => {
    return (
        <div className='h-screen w-screen relative '>
            <motion.h2 initial={{opacity:0,y:10}} animate={{y:0}} whileInView={{opacity:100}} transition={{duration:1}} className='relative md:left-1/3 left-10 text-2xl font-bold  md:text-3xl top-20'>Drive Success with Comprehensive Functionality</motion.h2>
