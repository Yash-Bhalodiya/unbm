...
const Landing = () => {
    return (
        <div className='relative top-0 left-0 bg-[#a9bcd0] text-2xl h-screen w-screen overflow-x-hidden'>
            <div id='prName' className='relative md:left-32 md:top-1/2 left-1/5 top-24'><motion.h1 initial={{opacity:0,y:-100}} animate={{y:0,opacity:100}} transition={{duration:1}} className='text-6xl underline md:left-5'>Urban Nexus</motion.h1><br></br><motion.h3 initial={{opacity:0,y:100}} animate={{y:0,opacity:100}} transition={{duration:1}} className='text-3xl -mt-5 tracking-widest'>Business Mapper</motion.h3></div>
    ...
    >
      ...
      <p className="mt-6 text-center md:text-left relative  md:left-10 md:px-10">
